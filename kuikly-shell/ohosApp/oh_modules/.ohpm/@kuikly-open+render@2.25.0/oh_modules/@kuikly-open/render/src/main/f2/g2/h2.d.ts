...
export const onInitRenderView: (instanceId: string, pageName: string, pageDataJsonStr: string, renderViewWidth: number, renderViewHeight: number, configJson: string, uiContext: object, resourcesManager: resourceManager.ResourceManager) => number;
 ...
 * @param data 事件参数
 */
export const sendEvent: (instanceId: string, event: string, data: KRValue) => void;
export const sendEventSync: (instanceId: string, event: string, data: KRValue, sync: boolean) => number;
