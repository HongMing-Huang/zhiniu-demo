...
#   8082  H5 入口（index.html + nativevue2.js 业务同源 + h5App.js 渲染框架）—— 主入口，单端口
#   8083  业务 JS bundle 兼容服务（旧链，仅存量 URL 使用）
#
# 用法：./scripts/dev.sh
set -e
cd "$(dirname "$0")/.."
